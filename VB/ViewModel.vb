...
Namespace MDI_Diagram
    ...
    Public Class ViewModel
        ...
        Private documentCount As Integer? = Nothing
        ...
        Public Sub CreateDocument(ByVal Optional vm As MDI_Diagram.DocumentViewModel = Nothing)
            If Not Me.documentCount.HasValue Then Me.documentCount = Me.DocumentManagerService.Documents.Count()
            Dim doc As DevExpress.Mvvm.IDocument = Me.DocumentManagerService.FindDocumentById(Me.documentCount)
            If doc Is Nothing Then
                If vm Is Nothing Then vm = New MDI_Diagram.DocumentViewModel()
                vm.Name = $"Document {Me.documentCount}"
                doc = Me.DocumentManagerService.CreateDocument(vm)
                doc.Id = Me.documentCount
                Me.documentCount += 1
            End If
        ...
        Public Sub SaveAll()
            If Me.SaveFileDialogService.ShowDialog() Then
                ...
                For Each doc In Me.DocumentManagerService.Documents
                    If TypeOf doc.Content Is MDI_Diagram.DocumentViewModel Then
                        Dim vm = CType(doc.Content, MDI_Diagram.DocumentViewModel)
